      ...
      {pendingDetailData ? (
        ...
        <ScrollView>
          ...
          <View style={styles.infoContainer}>
            ...
            {movieDetailData.spoken_languages.map((item,index) =><Text style={styles.spoken} key={index}>{item.name}</Text>
            )}

            <Text style={styles.language}>Production Countries</Text>
            {movieDetailData.production_countries.map((item,index) =><Text style={styles.spoken} key={index}>{item.name}</Text>
            )}
          </View>
        </ScrollView>
      )}
